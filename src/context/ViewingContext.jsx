...
const ALL_SECTIONS = ['myInfo', 'onboarding', 'team', 'appsAndPolicies', 'metrics', 'admin']
...
function sectionsByRole(role) {
  switch (role) {
    ...
    case 'owner':
    case 'leader':
      return ['myInfo', 'onboarding', 'team', 'appsAndPolicies', 'metrics']
    default: // agent
      return ['myInfo', 'appsAndPolicies', 'metrics']
  }
}
